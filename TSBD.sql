...
INSERT ALL
    ...
    VALUES(1,'Danza para Chile', '16:00' , '17:30', 35000, 'Efectivo', TO_DATE('2023-02-06','YYYY-MM-DD'),'25101996-5')

    INTO Evento(eve_codigo, eve_descripcion, eve_hora_inicio, eve_hora_fin, eve_valor_arriendo, eve_modalidad_pago, eve_fecha_pago, cli_rut)
    VALUES(2,'Tela', '17:00' , '18:30', 40000, 'Deposito', TO_DATE('2023-02-06','YYYY-MM-DD'),'56789012-3')

    INTO Evento(eve_codigo, eve_descripcion, eve_hora_inicio, eve_hora_fin, eve_valor_arriendo, eve_modalidad_pago, eve_fecha_pago, cli_rut)
    VALUES(3,'Arte y meditacion', '17:00' , '18:30', 3000, 'Efectivo', TO_DATE('2023-02-06','YYYY-MM-DD'),'10121993-0')
...
INSERT ALL
    ...
    VALUES(1,'Pilates',20000,60,4,TO_DATE('2023-02-06','YYYY-MM-DD'),TO_DATE('2023-12-29','YYYY-MM-DD'))

    INTO Cursos(cur_codigo, cur_descripcion, cur_valor_sesion, cur_duracion, cur_num_sesiones, cur_fecha_inicio, cur_fecha_termino)
    VALUES(2,'Yoga',23500,60,4,TO_DATE('2023-02-06','YYYY-MM-DD'),TO_DATE('2023-12-29','YYYY-MM-DD'))

    INTO Cursos(cur_codigo, cur_descripcion, cur_valor_sesion, cur_duracion, cur_num_sesiones, cur_fecha_inicio, cur_fecha_termino)
    VALUES(3,'Hidroterapia',25000,120,4,TO_DATE('2023-02-06','YYYY-MM-DD'),TO_DATE('2023-12-29','YYYY-MM-DD'))

    INTO Cursos(cur_codigo, cur_descripcion, cur_valor_sesion, cur_duracion, cur_num_sesiones, cur_fecha_inicio, cur_fecha_termino)
    VALUES(4,'Electroterapia',50000,30,4,TO_DATE('2023-02-06','YYYY-MM-DD'),TO_DATE('2023-12-29','YYYY-MM-DD'))

    INTO Cursos(cur_codigo, cur_descripcion, cur_valor_sesion, cur_duracion, cur_num_sesiones, cur_fecha_inicio, cur_fecha_termino)
    VALUES(5,'Terapia Manual',100000,8,3,TO_DATE('2023-02-06','YYYY-MM-DD'),TO_DATE('2023-12-29','YYYY-MM-DD'))

    INTO Cursos(cur_codigo, cur_descripcion, cur_valor_sesion, cur_duracion, cur_num_sesiones, cur_fecha_inicio, cur_fecha_termino)
    VALUES(6,'Rehabilitacion',75000,100,3,TO_DATE('2023-02-06','YYYY-MM-DD'),TO_DATE('2023-12-29','YYYY-MM-DD'))
...
--LUNES------------------------------------------------------------------------------------------------------------------------------
    ...
    VALUES(1,'Pilates',TO_DATE('2023-02-06','YYYY-MM-DD'),'09:00',2,'78945612-3')

    INTO Sesion(ses_codigo, ses_descripcion, ses_fecha, ses_hora, sal_codigo, ins_rut)
    VALUES(2,'Yoga',TO_DATE('2023-02-06','YYYY-MM-DD'),'10:30',3,'56789456-7')

    INTO Sesion(ses_codigo, ses_descripcion, ses_fecha, ses_hora, sal_codigo, ins_rut)
    VALUES(3,'Hidroterapia',TO_DATE('2023-02-06','YYYY-MM-DD'),'12:00',6,'45678945-1')

    INTO Sesion(ses_codigo, ses_descripcion, ses_fecha, ses_hora, sal_codigo, ins_rut)
    VALUES(4,'Electroterapia',TO_DATE('2023-02-06','YYYY-MM-DD'),'13:30',5,'78945612-3')
    
    --Programas--------------------------------------------
     INTO Sesion(ses_codigo, ses_descripcion, ses_fecha, ses_hora, sal_codigo, ins_rut)
    VALUES(24,'Meditacion y Natacion',TO_DATE('2023-02-06','YYYY-MM-DD'),'15:00',6,'45678945-1')

     INTO Sesion(ses_codigo, ses_descripcion, ses_fecha, ses_hora, sal_codigo, ins_rut)
    VALUES(25,'Lira Moderna',TO_DATE('2023-02-06','YYYY-MM-DD'),'16:30',1,'26983254-7')

     INTO Sesion(ses_codigo, ses_descripcion, ses_fecha, ses_hora, sal_codigo, ins_rut)
    VALUES(26,'Aumento Fuerza Corporal',TO_DATE('2023-02-06','YYYY-MM-DD'),'18:00',2,'45678945-1')

     INTO Sesion(ses_codigo, ses_descripcion, ses_fecha, ses_hora, sal_codigo, ins_rut)
    VALUES(27,'Musica y mas',TO_DATE('2023-02-06','YYYY-MM-DD'),'19:30',4,'45678945-1')
    
--MARTES------------------------------------------------------------------------------------------------------------------------------

    ----Cursos----------------------------------------
    INTO Sesion(ses_codigo, ses_descripcion, ses_fecha, ses_hora, sal_codigo, ins_rut)
    VALUES(5,'Terapia Manual',TO_DATE('2023-02-07','YYYY-MM-DD'),'09:00',5,'10527349-4')

    INTO Sesion(ses_codigo, ses_descripcion, ses_fecha, ses_hora, sal_codigo, ins_rut)
    VALUES(6,'Rehabilitación',TO_DATE('2023-02-07','YYYY-MM-DD'),'10:30',5,'78945612-3')

    INTO Sesion(ses_codigo, ses_descripcion, ses_fecha, ses_hora, sal_codigo, ins_rut)
    VALUES(7,'Pilates',TO_DATE('2023-02-07','YYYY-MM-DD'),'12:00',3,'78945612-3')

    INTO Sesion(ses_codigo, ses_descripcion, ses_fecha, ses_hora, sal_codigo, ins_rut)
    VALUES(8,'Yoga',TO_DATE('2023-02-07','YYYY-MM-DD'),'13:30',2,'56789456-7')

    
	--Programas--------------------------------------------
    INTO Sesion(ses_codigo, ses_descripcion, ses_fecha, ses_hora, sal_codigo, ins_rut)
    VALUES(28,'Meditacion y Natacion',TO_DATE('2023-02-06','YYYY-MM-DD'),'15:00',6,'45678945-1')

    INTO Sesion(ses_codigo, ses_descripcion, ses_fecha, ses_hora, sal_codigo, ins_rut)
    VALUES(29,'Yoga y Elasticidad',TO_DATE('2023-02-06','YYYY-MM-DD'),'16:30',2,'56789456-7')

    INTO Sesion(ses_codigo, ses_descripcion, ses_fecha, ses_hora, sal_codigo, ins_rut)
    VALUES(30,'Pilates y mas',TO_DATE('2023-02-06','YYYY-MM-DD'),'18:00',4,'67894561-0')

    INTO Sesion(ses_codigo, ses_descripcion, ses_fecha, ses_hora, sal_codigo, ins_rut)
    VALUES(31,'Aumento Fuerza Corporal',TO_DATE('2023-02-06','YYYY-MM-DD'),'19:30',2,'45678945-1')

--MIERCOLES------------------------------------------------------------------------------------------------------------------------------

    ----Cursos----------------------------------------
    INTO Sesion(ses_codigo, ses_descripcion, ses_fecha, ses_hora, sal_codigo, ins_rut)
    VALUES(9,'Hidroterapia',TO_DATE('2023-02-08','YYYY-MM-DD'),'09:00',6,'45678945-1')

    INTO Sesion(ses_codigo, ses_descripcion, ses_fecha, ses_hora, sal_codigo, ins_rut)
    VALUES(10,'Electroterapia',TO_DATE('2023-02-08','YYYY-MM-DD'),'10:30',5,'26983254-7')

    INTO Sesion(ses_codigo, ses_descripcion, ses_fecha, ses_hora, sal_codigo, ins_rut)
    VALUES(11,'Terapia Manual',TO_DATE('2023-02-08','YYYY-MM-DD'),'12:00',5,'10527349-4')

    INTO Sesion(ses_codigo, ses_descripcion, ses_fecha, ses_hora, sal_codigo, ins_rut)
    VALUES(12,'Rehabilitacion',TO_DATE('2023-02-08','YYYY-MM-DD'),'13:30',5,'78945612-3')

    --Programas--------------------------------------------
    INTO Sesion(ses_codigo, ses_descripcion, ses_fecha, ses_hora, sal_codigo, ins_rut)
    VALUES(32,'Telas y fuerza',TO_DATE('2023-02-06','YYYY-MM-DD'),'15:00',1,'56789456-7')

    INTO Sesion(ses_codigo, ses_descripcion, ses_fecha, ses_hora, sal_codigo, ins_rut)
    VALUES(33,'Yoga y Elasticidad',TO_DATE('2023-02-06','YYYY-MM-DD'),'16:30',2,'56789456-7')

    INTO Sesion(ses_codigo, ses_descripcion, ses_fecha, ses_hora, sal_codigo, ins_rut)
    VALUES(34,'Aumento Fuerza Corporal',TO_DATE('2023-02-06','YYYY-MM-DD'),'19:30',4,'45678945-1')

--JUEVES------------------------------------------------------------------------------------------------------------------------------

    ----Cursos----------------------------------------
    INTO Sesion(ses_codigo, ses_descripcion, ses_fecha, ses_hora, sal_codigo, ins_rut)
    VALUES(13,'Pilates',TO_DATE('2023-02-09','YYYY-MM-DD'),'09:00',2,'78945612-3')

    INTO Sesion(ses_codigo, ses_descripcion, ses_fecha, ses_hora, sal_codigo, ins_rut)
    VALUES(14,'Yoga',TO_DATE('2023-02-09','YYYY-MM-DD'),'10:30',3,'56789456-7')

    INTO Sesion(ses_codigo, ses_descripcion, ses_fecha, ses_hora, sal_codigo, ins_rut)
    VALUES(15,'Hedroterapia',TO_DATE('2023-02-09','YYYY-MM-DD'),'12:00',6,'45678945-1')

    INTO Sesion(ses_codigo, ses_descripcion, ses_fecha, ses_hora, sal_codigo, ins_rut)
    VALUES(16,'Electroterapia',TO_DATE('2023-02-09','YYYY-MM-DD'),'13:30',5,'26983254-7')

    --Programas--------------------------------------------
    INTO Sesion(ses_codigo, ses_descripcion, ses_fecha, ses_hora, sal_codigo, ins_rut)
    VALUES(35,'Telas y fuerza',TO_DATE('2023-02-06','YYYY-MM-DD'),'14:00',3,'45678945-1')

    INTO Sesion(ses_codigo, ses_descripcion, ses_fecha, ses_hora, sal_codigo, ins_rut)
    VALUES(36,'Lira moderna',TO_DATE('2023-02-06','YYYY-MM-DD'),'16:30',2,'26983254-7')

    INTO Sesion(ses_codigo, ses_descripcion, ses_fecha, ses_hora, sal_codigo, ins_rut)
    VALUES(37,'Aumento Fuerza Corporal',TO_DATE('2023-02-06','YYYY-MM-DD'),'18:00',4,'45678945-1')

    INTO Sesion(ses_codigo, ses_descripcion, ses_fecha, ses_hora, sal_codigo, ins_rut)
    VALUES(38,'Musica y mas',TO_DATE('2023-02-06','YYYY-MM-DD'),'19:30',1,'45678945-1')

--VIERNES------------------------------------------------------------------------------------------------------------------------------

    ----Cursos----------------------------------------
    INTO Sesion(ses_codigo, ses_descripcion, ses_fecha, ses_hora, sal_codigo, ins_rut)
    VALUES(17,'Terapia Manual',TO_DATE('2023-02-10','YYYY-MM-DD'),'09:00',5,'10527349-4')

    INTO Sesion(ses_codigo, ses_descripcion, ses_fecha, ses_hora, sal_codigo, ins_rut)
    VALUES(18,'Rehabilitacion',TO_DATE('2023-02-10','YYYY-MM-DD'),'10:30',5,'78945612-3')

    INTO Sesion(ses_codigo, ses_descripcion, ses_fecha, ses_hora, sal_codigo, ins_rut)
    VALUES(19,'Pilates',TO_DATE('2023-02-10','YYYY-MM-DD'),'12:00',3,'78945612-3')

    INTO Sesion(ses_codigo, ses_descripcion, ses_fecha, ses_hora, sal_codigo, ins_rut)
    VALUES(20,'Yoga',TO_DATE('2023-02-10','YYYY-MM-DD'),'13:30',2,'56789456-7')

    --Programas--------------------------------------------
    INTO Sesion(ses_codigo, ses_descripcion, ses_fecha, ses_hora, sal_codigo, ins_rut)
    VALUES(39,'Meditacion y Natacion',TO_DATE('2023-02-06','YYYY-MM-DD'),'15:00',6,'45678945-1')

    INTO Sesion(ses_codigo, ses_descripcion, ses_fecha, ses_hora, sal_codigo, ins_rut)
    VALUES(40,'Lira  moderna',TO_DATE('2023-02-06','YYYY-MM-DD'),'16:30',3,'45678945-1')

    INTO Sesion(ses_codigo, ses_descripcion, ses_fecha, ses_hora, sal_codigo, ins_rut)
    VALUES(41,'Pilates y mas',TO_DATE('2023-02-06','YYYY-MM-DD'),'18:00',2,'67894561-0')

    INTO Sesion(ses_codigo, ses_descripcion, ses_fecha, ses_hora, sal_codigo, ins_rut)
    VALUES(42,'Telas y fuerza',TO_DATE('2023-02-06','YYYY-MM-DD'),'19:30',2,'56789456-7')
    
--SABADO-------------------------------------------------------------------------------------------------------------------------------

    ----Cursos----------------------------------------
    INTO Sesion(ses_codigo, ses_descripcion, ses_fecha, ses_hora, sal_codigo, ins_rut)
    VALUES(21,'Hidroterapia',TO_DATE('2023-02-11','YYYY-MM-DD'),'09:00',6,'45678945-1')

    INTO Sesion(ses_codigo, ses_descripcion, ses_fecha, ses_hora, sal_codigo, ins_rut)
    VALUES(22,'Electroterapia',TO_DATE('2023-02-11','YYYY-MM-DD'),'10:30',5,'26983254-7')

    INTO Sesion(ses_codigo, ses_descripcion, ses_fecha, ses_hora, sal_codigo, ins_rut)
    VALUES(23,'Terapia Manual',TO_DATE('2023-02-12','YYYY-MM-DD'),'12:00',5,'10527349-4')

    --Programas--------------------------------------------
    INTO Sesion(ses_codigo, ses_descripcion, ses_fecha, ses_hora, sal_codigo, ins_rut)
    VALUES(43,'Meditacion y Natacion',TO_DATE('2023-02-06','YYYY-MM-DD'),'15:00',6,'45678945-1')

    INTO Sesion(ses_codigo, ses_descripcion, ses_fecha, ses_hora, sal_codigo, ins_rut)
    VALUES(44,'Yoga y Elasticidad',TO_DATE('2023-02-06','YYYY-MM-DD'),'16:30',3,'56789456-7')

    INTO Sesion(ses_codigo, ses_descripcion, ses_fecha, ses_hora, sal_codigo, ins_rut)
    VALUES(45,'Pilates y mas',TO_DATE('2023-02-06','YYYY-MM-DD'),'18:00',2,'67894561-0')

    INTO Sesion(ses_codigo, ses_descripcion, ses_fecha, ses_hora, sal_codigo, ins_rut)
    VALUES(46,'Musica y mas',TO_DATE('2023-02-06','YYYY-MM-DD'),'19:30',1,'10527349-4')
...
INSERT ALL
	...
	VALUES(1,'5 veces a la semana',21990,1)

	INTO Plan(pla_codigo, pla_modalidad, pla_valor, pro_codigo)
	VALUES(2,'6 veces a la semana',30000,2)
    ...
    INTO Plan(pla_codigo, pla_modalidad, pla_valor, pro_codigo)
	VALUES(6,'6 veces a la semana',59990,6)

    INTO Plan(pla_codigo, pla_modalidad, pla_valor, pro_codigo)
	VALUES(7,'6 veces a la semana',590,7)
...
INSERT ALL
    ...
    VALUES(1,TO_DATE('2023-01-03','YYYY-MM-DD'),TO_DATE('2024-12-29','YYYY-MM-DD'),'22032005-1')

    INTO Posee(est_codigo, fecha_inicio, fecha_termino, cli_rut)
    VALUES(1,TO_DATE('2023-01-03','YYYY-MM-DD'),TO_DATE('2024-12-29','YYYY-MM-DD'),'10121993-0')

    INTO Posee(est_codigo, fecha_inicio, fecha_termino, cli_rut)
    VALUES(2,TO_DATE('2023-01-01','YYYY-MM-DD'),TO_DATE('2024-08-31','YYYY-MM-DD'),'34567890-1')

    INTO Posee(est_codigo, fecha_inicio, fecha_termino, cli_rut)
    VALUES(1,TO_DATE('2023-01-03','YYYY-MM-DD'),TO_DATE('2023-12-29','YYYY-MM-DD'),'15012013-3')

    INTO Posee(est_codigo, fecha_inicio, fecha_termino, cli_rut)
    VALUES(1,TO_DATE('2023-01-03','YYYY-MM-DD'),TO_DATE('2023-12-29','YYYY-MM-DD'),'56789012-3')

    INTO Posee(est_codigo, fecha_inicio, fecha_termino, cli_rut)
    VALUES(1,TO_DATE('2023-01-03','YYYY-MM-DD'),TO_DATE('2023-12-29','YYYY-MM-DD'),'02122013-1')

    INTO Posee(est_codigo, fecha_inicio, fecha_termino, cli_rut)
    VALUES(2,TO_DATE('2023-01-01','YYYY-MM-DD'),TO_DATE('2023-03-31','YYYY-MM-DD'),'24042012-3')

    INTO Posee(est_codigo, fecha_inicio, fecha_termino, cli_rut)
    VALUES(1,TO_DATE('2023-01-03','YYYY-MM-DD'),TO_DATE('2023-12-29','YYYY-MM-DD'),'25101996-5')

    INTO Posee(est_codigo, fecha_inicio, fecha_termino, cli_rut)
    VALUES(1,TO_DATE('2023-01-03','YYYY-MM-DD'),TO_DATE('2023-12-29','YYYY-MM-DD'),'15112001-5')

    INTO Posee(est_codigo, fecha_inicio, fecha_termino, cli_rut)
    VALUES(2,TO_DATE('2023-01-01','YYYY-MM-DD'),TO_DATE('2023-03-31','YYYY-MM-DD'),'22032002-0')

    INTO Posee(est_codigo, fecha_inicio, fecha_termino, cli_rut)
    VALUES(2,TO_DATE('2023-01-01','YYYY-MM-DD'),TO_DATE('2023-03-31','YYYY-MM-DD'),'20051985-1')

    INTO Posee(est_codigo, fecha_inicio, fecha_termino, cli_rut)
    VALUES(2,TO_DATE('2023-01-01','YYYY-MM-DD'),TO_DATE('2023-03-31','YYYY-MM-DD'),'24061984-7')

    INTO Posee(est_codigo, fecha_inicio, fecha_termino, cli_rut)
    VALUES(1,TO_DATE('2023-01-03','YYYY-MM-DD'),TO_DATE('2023-12-29','YYYY-MM-DD'),'10021992-2')

    INTO Posee(est_codigo, fecha_inicio, fecha_termino, cli_rut)
    VALUES(1,TO_DATE('2023-01-03','YYYY-MM-DD'),TO_DATE('2023-12-29','YYYY-MM-DD'),'10041977-2')

    INTO Posee(est_codigo, fecha_inicio, fecha_termino, cli_rut)
    VALUES(1,TO_DATE('2023-01-03','YYYY-MM-DD'),TO_DATE('2023-12-29','YYYY-MM-DD'),'10051987-2')

    INTO Posee(est_codigo, fecha_inicio, fecha_termino, cli_rut)
    VALUES(1,TO_DATE('2023-01-03','YYYY-MM-DD'),TO_DATE('2023-12-29','YYYY-MM-DD'),'10051986-2')

    INTO Posee(est_codigo, fecha_inicio, fecha_termino, cli_rut)
    VALUES(1,TO_DATE('2023-01-03','YYYY-MM-DD'),TO_DATE('2023-12-29','YYYY-MM-DD'),'10011987-3')

    INTO Posee(est_codigo, fecha_inicio, fecha_termino, cli_rut)
    VALUES(1,TO_DATE('2023-01-01','YYYY-MM-DD'),TO_DATE('2023-03-31','YYYY-MM-DD'),'19240319-3')

    INTO Posee(est_codigo, fecha_inicio, fecha_termino, cli_rut)
    VALUES(1,TO_DATE('2023-01-03','YYYY-MM-DD'),TO_DATE('2023-12-29','YYYY-MM-DD'),'19261967-3')

    INTO Posee(est_codigo, fecha_inicio, fecha_termino, cli_rut)
    VALUES(1,TO_DATE('2023-01-03','YYYY-MM-DD'),TO_DATE('2023-12-29','YYYY-MM-DD'),'12306198-5')

    INTO Posee(est_codigo, fecha_inicio, fecha_termino, cli_rut)
    VALUES(1,TO_DATE('2023-01-03','YYYY-MM-DD'),TO_DATE('2023-12-29','YYYY-MM-DD'),'13220311-1')

    INTO Posee(est_codigo, fecha_inicio, fecha_termino, cli_rut)
    VALUES(2,TO_DATE('2023-01-01','YYYY-MM-DD'),TO_DATE('2023-03-31','YYYY-MM-DD'),'11041980-7')
...
INSERT ALL
	...
	VALUES(7,'22032005-1',TO_DATE('2024-05-03','YYYY-MM-DD'))

    INTO Contrata(pla_codigo, cli_rut, fecha)
	VALUES(7,'10121993-0',TO_DATE('2024-07-03','YYYY-MM-DD'))

    INTO Contrata(pla_codigo, cli_rut, fecha)
	VALUES(7,'56789012-3',TO_DATE('2023-01-03','YYYY-MM-DD'))

    INTO Contrata(pla_codigo, cli_rut, fecha)
	VALUES(7,'25101996-5',TO_DATE('2023-01-03','YYYY-MM-DD'))

    INTO Contrata(pla_codigo, cli_rut, fecha)
	VALUES(4,'15112001-5',TO_DATE('2023-01-03','YYYY-MM-DD'))

    INTO Contrata(pla_codigo, cli_rut, fecha)
	VALUES(2,'10051986-2',TO_DATE('2023-01-03','YYYY-MM-DD'))

    INTO Contrata(pla_codigo, cli_rut, fecha)
	VALUES(2,'10011987-3',TO_DATE('2023-01-03','YYYY-MM-DD'))

    INTO Contrata(pla_codigo, cli_rut, fecha)
	VALUES(6,'19240319-3',TO_DATE('2023-01-03','YYYY-MM-DD'))

    INTO Contrata(pla_codigo, cli_rut, fecha)
	VALUES(7,'19261967-3',TO_DATE('2023-01-03','YYYY-MM-DD'))

    INTO Contrata(pla_codigo, cli_rut, fecha)
	VALUES(6,'13220311-1',TO_DATE('2023-01-03','YYYY-MM-DD'))
...
INSERT ALL
	...
	VALUES(5,'22032005-1',TO_DATE('2023-01-03','YYYY-MM-DD'))

    INTO Inscribe(cur_codigo, cli_rut, fecha)
	VALUES(1,'10121993-0',TO_DATE('2023-01-03','YYYY-MM-DD'))

    INTO Inscribe(cur_codigo, cli_rut, fecha)
	VALUES(1,'56789012-3',TO_DATE('2023-01-03','YYYY-MM-DD'))
    
    INTO Inscribe(cur_codigo, cli_rut, fecha)
	VALUES(6,'02122013-1',TO_DATE('2023-01-03','YYYY-MM-DD'))

    INTO Inscribe(cur_codigo, cli_rut, fecha)
	VALUES(1,'25101996-5',TO_DATE('2023-01-03','YYYY-MM-DD'))

    INTO Inscribe(cur_codigo, cli_rut, fecha)
	VALUES(1,'15112001-5',TO_DATE('2023-01-03','YYYY-MM-DD'))

    INTO Inscribe(cur_codigo, cli_rut, fecha)
	VALUES(3,'10051987-2',TO_DATE('2023-01-03','YYYY-MM-DD'))

    INTO Inscribe(cur_codigo, cli_rut, fecha)
	VALUES(3,'10051986-2',TO_DATE('2023-01-03','YYYY-MM-DD'))
...
INSERT ALL
	...
	VALUES(1,TO_DATE('2022-12-22','YYYY-MM-DD'),'34567890-1')

    INTO Inscribe_dos(pro_codigo, fecha, cli_rut)
	VALUES(1,TO_DATE('2022-12-22','YYYY-MM-DD'),'15012013-3')

    INTO Inscribe_dos(pro_codigo, fecha, cli_rut)
	VALUES(7,TO_DATE('2022-12-22','YYYY-MM-DD'),'10051986-2')

    INTO Inscribe_dos(pro_codigo, fecha, cli_rut)
	VALUES(4,TO_DATE('2022-12-22','YYYY-MM-DD'),'19240319-3')

    INTO Inscribe_dos(pro_codigo, fecha, cli_rut)
	VALUES(5,TO_DATE('2022-12-22','YYYY-MM-DD'),'15112001-5')

    INTO Inscribe_dos(pro_codigo, fecha, cli_rut)
	VALUES(2,TO_DATE('2022-12-22','YYYY-MM-DD'),'19261967-3')

    INTO Inscribe_dos(pro_codigo, fecha, cli_rut)
	VALUES(3,TO_DATE('2022-12-22','YYYY-MM-DD'),'11041980-7')
...
-- Genere un programa en PL/SQL que sea capaz de generar un ranking con las --
-- comunas de los clientes con estado vigente que han contratado planes de entrenamiento de --
-- pilates en los ´ultimos 6 meses.--
